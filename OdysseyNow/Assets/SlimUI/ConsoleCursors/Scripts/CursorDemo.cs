...
public class CursorDemo : PointerInputModule {
    ...
    [Header("Cursor Controls")] public string horizontalAxis = "Horizontal";
    ...
    [Range(0.1f, 1.0f)] public float hoverMultiplier = 0.33f;
    ...
    public void NormalSpeed() {
        // When not hvoering anymore, back to normal speed
