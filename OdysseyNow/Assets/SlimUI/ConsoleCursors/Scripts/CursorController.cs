...
public class CursorController : PointerInputModule {
    ...
    [Tooltip("Left Boundary Offset")]
    public float xminOffset = 0.0f;
    [Tooltip("Right Boundary Offset")]
    public float xmaxOffset = 0.0f;
    [Tooltip("Bottom Boundary Offset")]
    public float yminOffset = 0.0f;
    [Tooltip("Top Boundary Offset")]
    ...
    [Header("Demo Stuff")]
    public bool cursorButton = true; // if the button is a cursor or a normal style template
   ...
   public override void Process (){
    ...
    public void NormalSpeed(){ // When not hvoering anymore, back to original start speed
